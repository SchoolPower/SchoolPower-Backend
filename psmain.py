...
class Subject:
    ...
    def handle(self, html):
        ...
        if self.grade=="_": self.grade="--"
        if self.mark=="_": self.mark="--"
...
subjects=[sub for sub in subjects if sub.grade != "--" or len(sub.assignments)!=0] # ignore it and remove it from the list
